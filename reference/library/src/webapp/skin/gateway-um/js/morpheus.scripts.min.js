...
$PBJQ(document).ready(function(){$PBJQ(".Mrphs-portalWrapper").css("min-height",$PBJQ(window).innerHeight(true));
if($PBJQ("#loginLink2").length==1){$PBJQ("#loginLink2").click(function(a){$PBJQ("body").append('<div id="Mrphs-xlogin-container" />');
...
$(window).scroll(function(){if($(document).scrollTop()>144){$("#toolMenu").addClass("scrolled")
}else{$("#toolMenu").removeClass("scrolled")
}});